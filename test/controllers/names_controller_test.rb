...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { recurring: @name.recurring, start_time: @name.start_time } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { recurring: @name.recurring, start_time: @name.start_time } }
